...
res <- run.Ted(ref.dat=ref.data.filtered, X=df_TCGA_t,cell.type.labels=label$cell_category,cell.subtype.labels=label_subtype$cell_category,
               tum.key='tumor',input.type="scRNA",n.cores=20,pdf.name="PuramTCGA",seed=60722)

# ?run.Ted
saveRDS(res,"/home/cke/BayesPrism/BP_Puramfiltered_decormarkers_withsub_TCGA_res.rds")
#final est cell type fraction in each bulk samples
saveRDS(res$res$final.gibbs.thet,"/home/cke/BayesPrism/BP_Puramfiltered_decormarkers_withsub_TCGA_res_celltypeprop.rds")
